...
//                                     </div>
//                                 </div>";   
//                         if($asistencia==0 || $asistencia== '0'){
//                             $inv_html .= "
//                                 <div class='confirm'>
//                                     <button id='btn-confirm' class='btn-confirm' onclick='confirmarAsistencia(\"confirm\")'>Confirmar</button>
//                                     <button id='btn-unconfirm' class='btn-confirm' onclick='confirmarAsistencia(\"reject\")'>Rechazar</button>
//                                     <input type='hidden' name='codigo_inv' id='codigo_inv' value='{$codigo}'>
//                                 </div>";
//                         }else if($asistencia==1 || $asistencia == '1'){
//                             $inv_html .= "
//                                 <div class='confirm'>
//                                     <button id='confirm-msg' class='confirm-msg'>Has confirmado</button>
//                                 </div>";
//                         }else if($asistencia==2 || $asistencia == '2'){
//                             $inv_html .= "
//                                 <div class='confirm'>
//                                     <button id='confirm-msg' class='confirm-msg'>Has rechazado</button>
//                                 </div>";
//                         }
                            
//                         $inv_html .=   "</div><!--page-cont-->
//                             </div><!--page-->  
//                         </div>
//                         <div class='column c-right'>
//                     </div> 
                    ...
                    <div class='row' id='row2'>
                        ...
                        <div class='column c-middle column2' id='content-here'> 
                            <div class='page'>
                                <div class='page-cont'>
                                    <div class='img-inv'>
                                        <img src='includes/img/invitaKaren.jpg' class='half'/>
                                        <div class='personalizacion personalizacion2'>
                                            <h1>{$nombre_familiar}</h1>
                                            <h2><span>({$invitados})</span> personas</h2>
                                        </div>
                                    </div>";   
